                                    ...
                                    with gr.Tab(label="Resize to", elem_id="img2img_tab_resize_to") as tab_scale_to:
                                        with FormRow():
                                            ...
                                            with gr.Column(elem_id="img2img_dimensions_row", scale=1, elem_classes="dimensions-tools"):
                                                ...
                                                detect_image_size_btn = ToolButton(value=detect_image_size_symbol, elem_id="img2img_detect_image_size_btn", tooltip="Apply size from img2img")
...
def versions_html():
    ...
    return f"""
version: <a href="https://github.com/kaalibro/stable-diffusion-webui-forge/commit/{commit}">{tag}</a>
&#x2000;•&#x2000;
